...
## Users and purpose
MapleStory players compare exported class upgrade orders, enter their existing node levels, and plan material spending. The README documents 54 supported classes, local per-class storage, two resource-limited orders, and mobile use. Orders remain a fixed reference rather than personalized damage optimization.
